...
The Neo Geo target is playable on an emulator and also on real hardware (tested on an AES with NeoSD cartridge). Current development phase is gameplay bug fixes. Sound will come next.
